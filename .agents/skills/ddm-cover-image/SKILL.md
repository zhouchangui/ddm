---
name: ddm-cover-image
description: Generates article cover images with 5 dimensions (type, palette, rendering, text, mood) combining 11 color palettes and 7 rendering styles. Supports cinematic (2.35:1), widescreen (16:9), and square (1:1) aspects. Use when user asks to "generate cover image", "create article cover", or "make cover". Uses ddm-image-gen as the fixed image generation backend.
version: 0.1.0
---
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.ddm-skills/ddm-cover-image/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/ddm-skills/ddm-cover-image/EXTEND.md` | XDG |
| 3 | `$HOME/.ddm-skills/ddm-cover-image/EXTEND.md` | User home |
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure ddm-cover-image preferences" / "重新配置"). The next run re-triggers first-time setup.
