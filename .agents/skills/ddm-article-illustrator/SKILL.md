---
name: ddm-article-illustrator
description: Analyzes article structure, identifies positions requiring visual aids, generates illustrations with Type × Style × Palette three-dimension approach. Use when user asks to "illustrate article", "add images", "generate images for article", or "为文章配图". Uses ddm-image-gen as the fixed image generation backend.
version: 0.1.0
---
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.ddm-skills/ddm-article-illustrator/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/ddm-skills/ddm-article-illustrator/EXTEND.md` | XDG |
| 3 | `$HOME/.ddm-skills/ddm-article-illustrator/EXTEND.md` | User home |
...
6. Use **ddm-image-gen** as the backend per the `## Image Generation Tools` section above.
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure ddm-article-illustrator preferences" / "重新配置"). The next run re-triggers first-time setup.
