...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "百搭智能提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 百搭智能 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "百搭智能模型服务 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 百搭智能 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 百搭智能 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 百搭智能 伺服器。",
  ...
  "toast.update.description": "百搭智能 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 百搭智能 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: 百搭智能 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "百搭智能提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 百搭智能 伺服器。",
  ...
  "settings.general.row.language.description": "變更 百搭智能 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 百搭智能 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 百搭智能 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 百搭智能 的主題。",
  ...
  "settings.updates.row.startup.description": "在 百搭智能 啟動時自動檢查更新",
