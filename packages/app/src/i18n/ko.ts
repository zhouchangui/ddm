export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "百搭智能에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 百搭智能에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.opencodeZen.line1":
    "百搭智能模型服务은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 百搭智能에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 百搭智能에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.server.description": "이 앱이 연결할 百搭智能 서버를 전환합니다.",
  ...
  "toast.update.description": "百搭智能의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 百搭智能 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: 百搭智能는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "百搭智能에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 百搭智能 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "百搭智能 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 百搭智能가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "百搭智能가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "百搭智能 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "百搭智能를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 百搭智能를 사용 중입니다.",
