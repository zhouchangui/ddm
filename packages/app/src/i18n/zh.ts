...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 百搭智能模型服务 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "百搭智能提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 百搭智能 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "百搭智能模型服务 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 百搭智能 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 百搭智能 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 百搭智能 服务器。",
  ...
  "toast.update.description": "百搭智能 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 百搭智能 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: 百搭智能 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "百搭智能提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 百搭智能 服务器。",
  ...
  "settings.general.row.language.description": "更改 百搭智能 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 百搭智能 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 百搭智能 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 百搭智能 的主题。",
  ...
  "settings.updates.row.startup.description": "在 百搭智能 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 百搭智能。",
