...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av 百搭智能",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i 百搭智能.",
  ...
  "provider.connect.opencodeZen.line1":
    "百搭智能模型服务 gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i 百搭智能.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i 百搭智能.",
  ...
  "dialog.server.description": "Bytt hvilken 百搭智能-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av 百搭智能 ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til 百搭智能-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at 百搭智能 ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "百搭智能 inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør 百搭智能-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for 百搭智能",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan 百搭智能 ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om 百搭智能 skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan 百搭智能 er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når 百搭智能 starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av 百搭智能.",
