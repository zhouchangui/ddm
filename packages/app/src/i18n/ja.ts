export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "百搭智能が提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、百搭智能で{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "百搭智能模型服务は、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続して百搭智能で{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、百搭智能で{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続する百搭智能サーバーを切り替えます。",
  ...
  "toast.update.description": "百搭智能の新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーを百搭智能チームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: 百搭智能はまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "百搭智能には無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境で百搭智能サーバーを実行します。",
  ...
  "settings.general.row.language.description": "百搭智能の表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでの百搭智能の表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "百搭智能がシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "百搭智能のテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "百搭智能 の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "百搭智能 は最新バージョンです。",
