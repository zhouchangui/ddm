export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af 百搭智能",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i 百搭智能.",
  ...
  "provider.connect.opencodeZen.line1":
    "百搭智能模型服务 giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i 百搭智能.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i 百搭智能.",
  ...
  "dialog.server.description": "Skift hvilken 百搭智能-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af 百搭智能 ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til 百搭智能-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, 百搭智能 understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "百搭智能 inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør 百搭智能-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for 百搭智能",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan 百搭智能 ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om 百搭智能 følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan 百搭智能 er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når 百搭智能 starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af 百搭智能.",
