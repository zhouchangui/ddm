export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje 百搭智能",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u 百搭智能-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "百搭智能模型服务 ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u 百搭智能-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u 百搭智能-u.",
  ...
  "dialog.server.description": "Promijeni na koji se 百搭智能 server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija 百搭智能-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku 百搭智能 timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: 百搭智能 još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "百搭智能 uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni 百搭智能 server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u 百搭智能-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako 百搭智能 izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li 百搭智能 prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu 百搭智能-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se 百搭智能 pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju 百搭智能-a.",
