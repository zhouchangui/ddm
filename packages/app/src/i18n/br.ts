export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo 百搭智能",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no 百搭智能.",
  ...
  "provider.connect.opencodeZen.line1":
    "百搭智能模型服务 oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no 百搭智能.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no 百搭智能.",
  ...
  "dialog.server.description": "Trocar para qual servidor 百搭智能 este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do 百搭智能 ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do 百搭智能",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: 百搭智能 ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "百搭智能 inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor 百搭智能 dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do 百搭智能",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o 百搭智能 aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o 百搭智能 segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o 百搭智能 é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o 百搭智能 iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do 百搭智能.",
