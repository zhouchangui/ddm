export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от 百搭智能",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в 百搭智能.",
  ...
  "provider.connect.opencodeZen.line1":
    "百搭智能模型服务 даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в 百搭智能.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в 百搭智能.",
  ...
  "dialog.server.description": "Переключите сервер 百搭智能 к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия 百搭智能 ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде 百搭智能",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что 百搭智能 пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "百搭智能 включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер 百搭智能 внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения 百搭智能",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как 百搭智能 выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли 百搭智能 системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление 百搭智能.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске 百搭智能",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию 百搭智能.",
