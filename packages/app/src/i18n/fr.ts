export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par 百搭智能",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans 百搭智能.",
  ...
  "provider.connect.opencodeZen.line1":
    "百搭智能模型服务 vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans 百搭智能.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans 百搭智能.",
  ...
  "dialog.server.description": "Changez le serveur 百搭智能 auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'百搭智能 ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe 百搭智能",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'百搭智能 ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "百搭智能 inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur 百搭智能 dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour 百搭智能",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'百搭智能 sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si 百搭智能 suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'百搭智能.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'百搭智能",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'百搭智能.",
