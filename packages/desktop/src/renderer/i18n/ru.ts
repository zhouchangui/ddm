export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию 百搭智能",
  ...
  "desktop.updater.downloaded.prompt": "Версия 百搭智能 {{version}} загружена. Хотите установить и перезапустить?",
