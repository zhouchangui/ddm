export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av 百搭智能",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av 百搭智能 er lastet ned. Vil du installere den og starte på nytt?",
