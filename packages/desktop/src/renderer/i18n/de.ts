export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von 百搭智能",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von 百搭智能 wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
