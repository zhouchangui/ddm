export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do 百搭智能",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do 百搭智能 foi baixada. Você gostaria de instalá-la e reiniciar?",
