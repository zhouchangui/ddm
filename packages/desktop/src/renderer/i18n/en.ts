export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of 百搭智能",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of 百搭智能 has been downloaded, would you like to install it and relaunch?",
