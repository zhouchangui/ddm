export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de 百搭智能",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de 百搭智能. ¿Quieres instalarla y reiniciar?",
